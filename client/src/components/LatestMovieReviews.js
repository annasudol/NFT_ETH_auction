...
import latestreview from "../../asset/nft.png";
...
export const LatestMovieReviews = ({
  latestReviews,
  latestSort,
  setLatestSort,
          ...
          <div className="xl:pl-10 flex flex-col w-full">
            <div className="py-7 flex justify-center sm:justify-start">
              <div className="inline-block border border-gray-500 sm:rounded-full ">
                <button
                  className={`px-7 py-1 font-semibold w-full sm:w-auto sm:rounded-full ${
                    latestSort == "movie" && "bg-gray-700"
                  }`}
                  onClick={handlemovie}
                >
                  Movie Reviews
                ...
                <button
                  className={`px-5 py-1 font-semibold w-full sm:w-auto sm:rounded-full ${
                    latestSort == "tv" && "bg-gray-700"
                  }`}
                      ...
                      <Slide index={key} key={key} className="cursor-grab">
                        <div className="p-2">
                          <div
                            ...
                            style={{
                              background:
                                "linear-gradient(180deg,rgba(255,255,255,.10126057258841037) 0,rgba(255,255,255,0) 100%)",
                            }}
                          >
                            {/* card */}
                            <div className="flex flex-col px-5 py-4">
                              <div className="flex items-center">
                                <Jazzicon
                                  diameter={35}
                                  seed={parseInt(
                                    reviews?.useraddress.slice(2, 10),
                                    16
                                  )}
                                />
                                <div>
                                  <p className="text-gray-50 font-semibold text-sm ml-2">
                                    {reviews.useraddress.slice(0, 5) +
                                      "..." +
                                      reviews.useraddress.slice(-4)}
                                  </p>
                                </div>
                              </div>
                              <div className=" py-5">
